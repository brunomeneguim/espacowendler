...
export default async function CompletarPerfilPage() {
  ...
  const [{ data: profReg }, { data: especialidades }, { data: configsRaw }] =
    await Promise.all([
      supabase
        .from("profissionais")
        .select("id, foto_url, data_nascimento, sexo, cpf, cnpj, uf_conselho, cbos_codigo, cbos_nome, horario_inicio, horario_fim, tempo_atendimento, observacoes, registro_profissional, especialidade_id, perfil_completo")
