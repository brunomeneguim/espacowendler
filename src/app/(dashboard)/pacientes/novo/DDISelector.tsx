  ...
  return (
    <div ref={ref} className="relative h-full">
      ...
      <button
        type="button"
        onClick={() => setOpen(v => !v)}
        className="flex items-center gap-1.5 py-2.5 px-3 w-[90px] border border-sand/40 rounded-l-lg bg-white hover:bg-sand/10 transition-colors text-sm font-medium text-forest border-r-0 shrink-0 h-full"
